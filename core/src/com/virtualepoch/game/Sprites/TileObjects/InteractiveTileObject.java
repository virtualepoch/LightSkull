...
public abstract class InteractiveTileObject {
    ...
    public InteractiveTileObject(PlayScreen screen, MapObject object){
        ...
        bdef.position.set((bounds.getX() + bounds.getWidth() / 2) / LightSkull.PPM, (bounds.getY() + bounds.getHeight() / 2) / LightSkull.PPM);

        body = world.createBody(bdef);

        shape.setAsBox(bounds.getWidth() / 2 / LightSkull.PPM, bounds.getHeight() / 2 / LightSkull.PPM);
        fdef.shape = shape;
